...
function Header() {
    ...
    return (<header className="flex items-center justify-between p-4 bg-slate-900 border-b shadow-sm">
            {/* Left: Mobile toggle */}
            ...
            {sidebarOpen && (<div className="fixed inset-0 z-50 bg-black/30 md:hidden">
                    <div className="w-64 bg-slate-900 h-full shadow-md p-4">
                        {/* Add your sidebar nav items here */}
                        <button className="text-sm text-gray-500 mb-4" onClick={() => setSidebarOpen(false)}>
